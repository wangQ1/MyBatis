...
public class Tests {
	...
	public static SqlSession getSession() throws IOException{
		String resource = "cn/et/关系映射/annotation/myBatisConfig.xml";
	...
	public void queryStudentById() throws IOException{
		...
		System.out.println(stu.getStuName() + "-----" + stu.getCla().getClaName());
	}
	@Test
	public void queryClassById() throws IOException{
		SqlSession session = getSession();
		ClassMapper sm = session.getMapper(ClassMapper.class);//获取实现类
		Classes cla = sm.queryClassById(1);//获取1号班的所有学生信息
